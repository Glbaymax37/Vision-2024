...
void ProcessImages() {
    ...
    createTrackbar("hmin", "Result", &whmin, 0);
    createTrackbar("smin", "Result", &wsmin, 0);
    createTrackbar("vmin", "Result", &wvmin, 0);
...
void bola(){   
    ...
    auto publisher = node->create_publisher<geometry_msgs::msg::Twist>("Posisi_Bola", 10); // Create a publisher for object coordinates
