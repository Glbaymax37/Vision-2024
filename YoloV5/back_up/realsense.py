...
class CameraPublisher(Node):
    ...
    def __init__(self):
        ...
        # Initialize the device for inference
    ...
    def camera_callback(self):
        ...
        for *xyxy, conf, cls in reversed(det):
            ...
            cv2.putText(img0, f'({center_x}, {center_y})', (center_x + 10, center_y + 10), cv2.FONT_HERSHEY_SIMPLEX,
                        0.7, (255, 0, 0), 2)
    ...
    def shutdown_callback(self):
        # Release the RealSense pipeline and destroy any OpenCV windows
        self.pipeline.stop()
