...
void Silo() {
    ...
    int slices = images.size();
       ...
       while (true) {
        ...
        int x1 =  380 /2;//(640 - 320) / 2;  // Top-left corner X coordinate
        int y1 = 0;//(480 - 240) / 2;  // Top-left corner Y coordinate
        int x2 = x1 + 320;         // Bottom-right corner X coordinate
        int y2 = y1 + 10;    
        // Ubah warna ke HSV
    frame(cv::Rect(x1, y1, 300, 360)).copyTo(displayFrame(cv::Rect(x1, y1, 300, 360)));
...
while (true) {
    ...
    if(keyVal == 49){
        file <<"int Hue = " << hue << endl;
        file <<"int lowhue1 = " << lowhue << ", " <<"smin1 = " << smin << ","<<"vmin1 = " << vmin << ";"<< endl;
        file << "int upperhue1 = " << upperhue << ", " << "smax1 = " << smax << "," << "vmax1 = " << vmax <<";"<<endl;

    }

    if(keyVal == 50){
        file <<"int Hue = " << hue << endl;
        file <<"int lowhue2 = " << lowhue << ", " <<"smin2 = " << smin << ","<<"vmin2 = " << vmin << ";"<< endl;
        file << "int upperhue2 = " << upperhue << ", " << "smax2 = " << smax << "," << "vmax2 = " << vmax <<";"<<endl;
