...
int lowhue2 = 115, smin2 = 36, vmin2 = 13;
int upperhue2 = 129 ,smax2 = 255, vmax2 = 255;
    ...
    // while (rclcpp::ok) {
        ...
        if (maxAreaIdx2 != -1 && maxArea2 > 100) {
           ...
           bola_ungu = contours_count2; 
            ...
            // contours_count_total = contours_count1 + contours_count2;

            contours_count_total = bola_merah + bola_ungu;

          
            cout << bola_merah << endl;
            cout << "///////////////////////////"<< endl;
            cout << bola_ungu << endl;
            cout << "///////////////////////////"<< endl;
            cout << contours_count_total << endl;
